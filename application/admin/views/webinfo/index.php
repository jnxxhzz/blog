...
<div class="uk-panel uk-panel-box">                 
    ...
    <form id="webinfo_form" class="uk-form uk-form-horizontal" enctype="multipart/form-data">
        ...
        <div class="uk-form-row">
            <label class="uk-form-label uk-text-bold uk-text-primary" for="csdn">csdn博客</label>
            <div class="uk-form-controls">
                <input class="uk-form-large uk-form-width-large" type="text" id="csdn" name="csdn" placeholder="你的csdn博客地址..." required="required" maxlength="128" value="<?php echo $webinfo['csdn'] ?>">
            </div>
        </div>
        <hr><br>
