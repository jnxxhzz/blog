...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(AD_CSS_PATH.'jnxxhzz.admin.min.css'); ?>" >
...
<body>
            ...
            <nav class="uk-navbar">
                <ul class="uk-navbar-nav">
                    <li class="uk-navbar-brand">
                        <img src="<?php echo base_url(IMG_PATH.'blogadmin.png'); ?>" width="130">
                    </li>
    ...
    <footer class="tm-footer">
        <div class="uk-container uk-container-center uk-text-center">
            ...
            <img src="<?php echo base_url(IMG_PATH.'jnxxhzzblog_white.png'); ?>" width="90" height="30" title="jnxxhzzBlog" alt="jnxxhzzBlog">           
        </div>
    </footer><!-- //脚部 -->
